...
from DeRestormer import DeRestormer as mynet
from skimage import img_as_ubyte
from get_parameter_number import get_parameter_number
from tqdm import tqdm
from layers import *

parser = argparse.ArgumentParser(description='Image Desnowing')
parser.add_argument('--input_dir', default='./Dataset/CSD-png/test/input', type=str, help='Directory of validation images')
parser.add_argument('--output_dir', default='./results/CSD-Ablation', type=str, help='Directory of validation images')
parser.add_argument('--weights', default='./ckpt/CSD/models/Multiscale/model_best.pth', type=str, help='Path to weights') 
