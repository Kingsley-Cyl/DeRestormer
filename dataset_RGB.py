...
class DataLoaderTrain(Dataset):
    def __init__(self, rgb_dir, img_options=None):
        ...
        if os.path.isfile(rgb_dir) and rgb_dir.endswith('.txt'):  # txt index file
            self.inp_filenames = []
            self.tar_filenames = []
            with open(rgb_dir, 'r') as f:
                for line in f:
                    inp, tar = line.strip().split()
                    self.inp_filenames.append(inp)
                    self.tar_filenames.append(tar)
        else:  # dir
...
class DataLoaderVal(Dataset):
    def __init__(self, rgb_dir, img_options=None):
        ...
        if os.path.isfile(rgb_dir) and rgb_dir.endswith('.txt'):
            self.inp_filenames = []
            self.tar_filenames = []
            with open(rgb_dir, 'r') as f:
                for line in f:
